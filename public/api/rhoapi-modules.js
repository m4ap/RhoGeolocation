...
// Module Rho.DeviceMemory


(function ($, rho, rhoUtil) {
    'use strict';

    var moduleNS = 'Rho.DeviceMemory';
    var apiReq = rhoUtil.apiReqFor(moduleNS);


    // === DeviceMemory class definition ===
    ...
    // === DeviceMemory instance properties ===

    rhoUtil.createPropsProxy(DeviceMemory.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === DeviceMemory instance methods ===

    rhoUtil.createMethodsProxy(DeviceMemory.prototype, [
    
    ], apiReq, function(){ return this.getId(); });

    

    rhoUtil.createRawPropsProxy(DeviceMemory.prototype, [
    ]);

    // === DeviceMemory constants ===

    
            DeviceMemory.DEVICE_MEMORY_STATUS_CRITICAL = 'DEVICE_MEMORY_STATUS_CRITICAL'; 
    
            DeviceMemory.DEVICE_MEMORY_STATUS_LOW = 'DEVICE_MEMORY_STATUS_LOW'; 
    



    // === DeviceMemory static properties ===

    rhoUtil.createPropsProxy(DeviceMemory, [
    ], apiReq);

    // === DeviceMemory static methods ===

    rhoUtil.createMethodsProxy(DeviceMemory, [
    
          // function(/* optional function */ oResult)
          { methodName: 'startListeningPlatformMemoryWarning', nativeName: 'startListeningPlatformMemoryWarning', persistentCallbackIndex: 0, valueCallbackIndex: 2 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'stopListeningPlatformMemoryWarning', nativeName: 'stopListeningPlatformMemoryWarning', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'getAvailableMemory', nativeName: 'getAvailableMemory', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'getInternalStorage', nativeName: 'getInternalStorage', valueCallbackIndex: 0 }
    
          // function(/* optional function */ oResult)
        , { methodName: 'getExternalStorage', nativeName: 'getExternalStorage', valueCallbackIndex: 0 }
    
    ], apiReq);

    // === DeviceMemory default instance support ===
    

    rhoUtil.namespace(moduleNS, DeviceMemory);
...
(function ($, rho, rhoUtil) {
    ...
    var moduleNS = 'Rho.Sip';
    var apiReq = rhoUtil.apiReqFor(moduleNS);


    // === Sip class definition ===
    ...
    // === Sip instance properties ===

    rhoUtil.createPropsProxy(Sip.prototype, [
    ], apiReq, function(){ return this.getId(); });

    // === Sip instance methods ===

    rhoUtil.createMethodsProxy(Sip.prototype, [
    
    ], apiReq, function(){ return this.getId(); });

    

    rhoUtil.createRawPropsProxy(Sip.prototype, [
    ]);
    ...
    // === Sip static properties ===

    rhoUtil.createPropsProxy(Sip, [
    ], apiReq);

    // === Sip static methods ===

    rhoUtil.createMethodsProxy(Sip, [
    ...
    // === Sip default instance support ===
    

    rhoUtil.namespace(moduleNS, Sip);
